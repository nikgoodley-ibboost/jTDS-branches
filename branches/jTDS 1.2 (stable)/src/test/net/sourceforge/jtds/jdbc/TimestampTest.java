...
public class TimestampTest extends DatabaseTestCase {
   ...
   /**
    * <p> Regression test for bug #699, conversion from String value of
    * Timestamp to Date fails. </p>
    */
      ...
      throws Exception
   {
      ...
      Statement sta = con.createStatement();
      sta.executeUpdate( "create table #Bug699 (A datetime)" );
      ...
      assertTrue( res.next() );
      assertEquals( new Date( ts.getTime() ), res.getDate( 1 ) );
      ...
      throws Exception
   {
       ...
       throws Exception
    {
       ...
       if( dateSupported )
       {
          ...
          String[] valid = new String[] { "0001-01-01", "1111-11-11", "8888-08-08", "9999-12-31" };
