...
public class Tds9Test extends TestBase {
    ...
    public void testReadUDT() throws Exception {
        if (!con.getMetaData().getDatabaseProductVersion().startsWith("09.")) {
           return;
        }
        try {
            dropTable("jtds_UDT");
    ...
    public void testXMLFunction() throws Exception {
        try {
            ...
            stmt.execute(
                    "CREATE FUNCTION f_xmlret(@data xml) RETURNS xml AS\r\n" +
                    "BEGIN\r\n" +
...
*/
   ...
   public void testReadVarbinaryMax() throws Exception {
    ...
    /**
     * SQL 2005 allows varchar(max) as the output parameter of a 
     * stored procedure. Test this functionality now.
     * @throws Exception
     */
    ...
    /**
     * SQL 2005 allows nvarchar(max) as the output parameter of a 
     * stored procedure. Test this functionality now.
     * @throws Exception
     */
    ...
    /**
     * SQL 2005 allows varbinary(max) as the output parameter of a 
     * stored procedure. Test this functionality now.
     * @throws Exception
     */
    ...
    /**
     * SQL 2005 allows varbinary(max) as the output parameter of a 
     * stored procedure. As xml columns will not be converted to 
     * varchar or nvarchar automatically the driver must supply an 
     * xml output parameter. JDBC 4 includes a new Types constant 
     * called SQLXML internal value 2009. In anticipation of JDBC 4
     * this driver now supports using this constant to set the 
     * correct type of output parameter.
     * @throws Exception
     */
...
//        cstmt.registerOutParameter(2, JtdsCallableStatement.SQLXML);
        cstmt.registerOutParameter(2, 2009);
        cstmt.execute();
