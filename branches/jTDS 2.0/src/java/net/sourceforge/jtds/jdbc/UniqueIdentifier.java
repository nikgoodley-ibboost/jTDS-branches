 ...
 * @version $Id: UniqueIdentifier.java,v 1.1 2007-09-10 19:19:31 bheineman Exp $
 */
class UniqueIdentifier implements Serializable {
    static final long serialVersionUID = 7456632787741827660L;
     ...
     */
    UniqueIdentifier(final byte[] id) {
        bytes = id;
    }
