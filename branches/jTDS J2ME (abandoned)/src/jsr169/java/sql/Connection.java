 ...
 * capabilities of this connection, and so on. This information is obtained
 * with the <code>getMetaData</code> method.
 * <p/>
 * <b>Note:</b> By default a <code>Connection</code> object is in auto-commit
 * mode, which means that it automatically commits changes after executing each
 * statement. If auto-commit mode has been disabled, the method
 * <code>commit</code> must be called explicitly in order to commit changes;
...
public interface Connection {
     ...
     * reads can occur. This level allows a row changed by one transaction to
     * be read by another transaction before any changes in that row have been
     ...
     * to either the method <code>commit</code> or the method
     ...
     * A connection is closed if the method <code>close</code> has been called
     * on it or if certain fatal errors have occurred. This method is
     * guaranteed to return <code>true</code> only when it is called after the
     * method <code>Connection.close</code> has been called.
     * <p/>
     ...
     * <code>Connection</code> object to the one given. The constants defined
     * in the interface <code>Connection</code> are the possible transaction
     * isolation levels.
     * <p/>
     ...
     *                      parameter is not one of the <code>Connection</code>
     *                      constants
     ...
     * subsequent warnings will be chained to the first one and can be
     * retrieved by calling the method <code>SQLWarning.getNextWarning</code>
     ...
     *
     * @return the first <code>SQLWarning</code> object or null if there are
     *         none
     * @throws SQLException if a database access error occurs or this method is
     ...
     * using <code>Statement</code> objects. If the same SQL statement is
     ...
     * but it allows the default result set type, concurrency, and holdability
     * to be overridden.
     *
     ...
     * throw certain <code>SQLException</code>s.
     * <P>
     * Result sets created using the returned <code>PreparedStatement</code>
     * object will by default be type <code>TYPE_FORWARD_ONLY</code> and have a
     * concurrency level of <code>CONCUR_READ_ONLY</code>.
     ...
     * @exception SQLException if a database access error occurs or the given
     *                         parameter is not a <code>Statement</code>
     *                         constant indicating whether auto-generated keys
     *                         should be returned
     */
     ...
     * certain <code>SQLException</code>s.
     * <p/>
     ...
     *                      not a <code>ResultSet</code> constant indicating
     ...
     *                         <code>Savepoint</code> object is no longer valid,
     ...
     * @exception SQLException if a database access error occurs or the given
     *                         <code>Savepoint</code> object is not a valid
