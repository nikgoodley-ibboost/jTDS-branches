 ...
 * Implementation note:
 * <p>
 * This is basically the code from the original jTDS TdsCore.
...
public class DatabaseMetaDataImpl implements java.sql.DatabaseMetaData {
    ...
    // Internal data needed by this implementation.
    ...
    public java.sql.ResultSet getCatalogs() throws SQLException {
        ...
        // FIXME: Why case insensitive? This will kind of corrupt the result.
    ...
    /**
     * Returns the name of this JDBC TdsCore.
     *
     * @return JDBC driver name
     * @throws SQLException if a database-access error occurs.
     */
    public String getDriverName() throws SQLException {
        return "jTDS Type 4 JDBC Driver for MS SQL Server, Sybase Adaptive Server Enterprise and Sybase Adaptive Server Anywhere";
    }

    /**
     * Returns the version of this JDBC TdsCore.
     *
    ...
    // based on the target database with the current TdsCore.
    ...
    public int getMaxIndexLength() throws SQLException {
        ...
        // per "Programming ODBC for SQLServer" Appendix A
        return (tdsVersion >= TdsCore.TDS70) ? 900 : 255;
    }
    ...
    public int getMaxTablesInSelect() throws SQLException {
        ...
        // per "Programming ODBC for SQLServer" Appendix A
        return (tdsVersion > TdsCore.TDS50) ? 256 : 16;
    }
    ...
    throws SQLException {
        ...
        ResultSetImpl rs = (ResultSetImpl) cstmt.executeQuery();
        ResultSetImpl rsTmp = new ResultSetImpl((StatementImpl)cstmt, colNames, colTypes);
        rsTmp.moveToInsertRow();
        int colCnt = rs.getMetaData().getColumnCount();
        //
        // Copy results to local result set.
    ...
    public java.sql.ResultSet getTypeInfo() throws SQLException {
        ...
        try {
            ...
            // ResultSet retains reference to same statement as rs, so don't close statement
            rs.close();
        }
    }
    ...
    public java.sql.ResultSet getUDTs(String catalog,
        ...
        //
        StatementImpl dummyStmt = (StatementImpl) connection.createStatement();
        ResultSetImpl rs = new ResultSetImpl(dummyStmt, colNames, colTypes);
     ...
     * @throws SQLException
     */
    private static void upperCaseColumnNames(ResultSetImpl results)
            throws SQLException {
    ...
    private ResultSetImpl createTypeInfoResultSet(ResultSetImpl rs, boolean useLOBs) throws SQLException {
        ResultSetImpl result = new ResultSetImpl((StatementImpl)rs.getStatement(), 
                                                    ResultSet.CONCUR_READ_ONLY,
                                                    ResultSet.TYPE_FORWARD_ONLY);
        result.setColumns(rs.getColumns());
        ...
        result.setResultSetConcurrency(ResultSet.CONCUR_UPDATABLE);
        ...
        result.setResultSetConcurrency(ResultSet.CONCUR_READ_ONLY);

        return result;
    }

    private Collection<TypeInfo> getSortedTypes(ResultSet rs, boolean useLOBs) throws SQLException {
        List<TypeInfo> types = new ArrayList<TypeInfo>(40);  // 40 should be enough capacity to hold all types
    ...
    static class TypeInfo implements Comparable {
        ...
        TypeInfo(ResultSet rs, boolean useLOBs) throws SQLException {
