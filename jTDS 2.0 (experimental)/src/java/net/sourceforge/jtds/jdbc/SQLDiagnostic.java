...
public class SQLDiagnostic {
     ...
     */
    private final static HashMap<Integer,String> mssqlStates = new HashMap<Integer,String>();
     ...
     * FreeTDS project. Thank you for the hard work.
     */
    private final static HashMap<Integer,String> sybStates = new HashMap<Integer,String>();
    ...
    static {
        ...
        mssqlStates.put(new Integer(3960), "S0005"); // See RFE [1491811]
        ...
        sybStates.put(new Integer(2601), "23000");
    ...
    /**
     * SQL Server type. Either <code>TdsCore.SQLSERVER</code> or
     * <code>TdsCore.SYBASE</code>.
     */
    ...
    synchronized void addWarning(final SQLWarning w) {
    ...
    synchronized void addException(final SQLException e) {
     ...
     */
    void addDiagnostic(final int number,
                       final int serverity,
    ...
    /**
     * Clear the exception chain.
     */
    synchronized void clearExceptions() {
        exceptions = null;
    }
     ...
     * @throws SQLException
     */
    synchronized void checkErrors() throws SQLException {
        if (exceptions != null) {
     ...
     *
     * @return The exception chain head as a <code>SQLWarning</code>.
     */
     ...
     *
     * @param serverType either <code>TdsCore.SQLSERVER</code> or <code>TdsCore.SYBASE</code>
     */
     ...
     * @param serverType <code>TdsCore.SQLSERVER</code> or <code>TdsCore.SYBASE</code>
