 ...
 * @version $Id: ParameterMetaDataImpl.java,v 1.3 2009-09-27 12:59:02 ickzon Exp $
 */
public class ParameterMetaDataImpl implements ParameterMetaData {
    ...
    ParameterMetaDataImpl(final ParamInfo[] parameterList, 
                          final ConnectionImpl connection) 
    {
        if (parameterList == null) {
            this.parameterList = new ParamInfo[0];
        } else {
    ...
    public int isNullable(int param) throws SQLException {
        return (getParameter(param).value == null)?
